class Router:
    ...
    def route(
        ...
        try:
            ...
            # INTERNET
            #
            # Online requests stay online.
            #
            # If the online service fails, do not
            # accidentally answer with unrelated
            # offline knowledge.
            # ------------------------------------------
            ...
            # LOCAL KNOWLEDGE
            #
            # Try offline knowledge first.
            # If it fails, then try online.
            # ------------------------------------------
    ...
    def _comparison(
        ...
        if (
            ...
            return (
                ...
                "while ROM is used to retain persistent instructions "
                "or firmware."
            )
        ...
        if (
            ...
            return (
                ...
                "- Excellent for graphics, video processing, "
                "AI and other parallel workloads\n"
        ...
        return self._generic_comparison(
            lower
        )
    ...
    def _generic_comparison(
        ...
        return (
            ...
            f"{left} and {right}.\n\n"
            "I don't have dedicated offline comparison "
            "data for these two topics yet. I can use my "
            "online intelligence to find current information "
            "about them."
        )
