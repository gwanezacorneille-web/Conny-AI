class DecisionEngine:
    ...
    V7 additions:
        - Understands IntentEngine online intents
        - Routes online intents to the Internet decision
        - Preserves existing V6 behavior
    """
    ...
    def __init__(self):
        ...
        # IntentEngine intents handled by Online Body
    ...
    def choose(
        ...
        # V7 ONLINE INTENTS
        #
        # IntentEngine has already identified this
        # request as an online request.
        #
        # All online intents use the "internet"
        # decision because Router._online() is the
        # execution layer.
        # ==============================================
